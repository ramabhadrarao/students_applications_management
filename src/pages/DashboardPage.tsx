...
import { FileText, Users, BookOpen, CheckCircle, AlertCircle, Clock, User } from 'lucide-react';
      ...
      try {
        ...
        if (user?.role === 'admin') {
          try {
            ...
            console.log('Admin stats not available, using general stats');
          }
        } else {
          try {
            const { data } = await axios.get('/api/applications?limit=1000');
            // Count applications by status
            const statusCounts = data.docs.reduce((acc: any, app: any) => {
            ...
            console.log('Applications stats not available');
          }
        }
        ...
        if (user?.role === 'admin') {
          try {
            ...
            console.log('Programs count not available');
          }
        }
        ...
        try {
          ...
          console.log('Recent applications not available');
          setRecentApplications([]);
        }
        
        setStats({
          totalApplications: appStats.totalApplications || 0,
          draftApplications: appStats.draft || 0,
          submittedApplications: appStats.submitted || 0,
          underReviewApplications: appStats.under_review || 0,
                    ...
                    <div className="mt-2 sm:flex sm:justify-between">
                      <div className="sm:flex">
                        <p className="flex items-center text-sm text-gray-500">
                          Program: {app.programId?.programName || 'N/A'}
                        </p>
                      </div>
